...
export class TransactionProductSchema extends BaseModel {
  static $columns = ['productId', 'quantity', 'transactionId', 'unitPrice'] as const
...
export class TransactionSchema extends BaseModel {
  static $columns = ['clientId', 'createdAt', 'externalId', 'gatewayId', 'id', 'status', 'totalAmount', 'updatedAt'] as const
